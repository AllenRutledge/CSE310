...
if xChoice.upper() == "LEFT":
    ...
    if cabinChoice.upper() == "KNOCK":
        ...
        if inCabinChoice.upper() == "SPEAK":
            ...
            inCabinChoice = input(invalidText)
    elif cabinChoice.upper() == "SNEAK":
        ending(3)
    else:RIGHT
        cabinChoice = input(invalidText)
    # CAR OPTIONS ------------------------------------------------------
    ...
    if caveChoice.upper() == "ENTER":
        ...
        if roadChoice.upper() == "HITCHHIKE":
            ...
            if factoryChoice.upper() == "WALK":
                ...
                factoryChoice = input(invalidText)
        else:
            roadChoice = input(invalidText)
    else:
        caveChoice = input(invalidText)
else:
    xChoice = input(invalidText)